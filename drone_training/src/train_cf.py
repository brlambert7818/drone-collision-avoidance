...
if __name__ == '__main__':
    ...
    log_dir = 'models/hover/box_world/distance_reward/'
    ...
    # checkpoint_callback = CheckpointCallback(save_freq=500, save_path='./' + log_dir, name_prefix='ppo2')
    ...
    # model = PPO2.load(log_dir + 'ppo2_58000_steps')
    # model.set_env(env)
    # model.learn(total_timesteps=60000, reset_num_timesteps=True)

    results_plotter.plot_results([log_dir], 60000, results_plotter.X_TIMESTEPS, "PPO Crazyflie")
    plt.show()
