...
def make_env(env_id, rank, log_dir, gazebo, gazebo_process, cf_process, seed=1):
    """
...
if __name__ == '__main__':
    ...
    env = DummyVecEnv([make_env(env_id, i, log_dir, gazebo, os.getpgid(gazebo_process.pid), os.getpgid(cf_process.pid)) for i in range(num_cpu)])
